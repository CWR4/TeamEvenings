 ...
 */
final class Version20190521090003 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie_night CHANGE movie_id_id movie_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE movie_night CHANGE movie_id movie_id_id INT DEFAULT NULL');
    }
}
